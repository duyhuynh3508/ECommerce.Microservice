...
{
    public interface ICurrencyRepository : IBaseRepository<BasketItem>
    {
    }
    ...
    public class CurrencyRepository : ICurrencyRepository
    {
        ...
        public async Task<ResponseResult> CreateAsync(BasketItem entity)
        {
            if (entity == null)
        ...
        public async Task<IEnumerable<BasketItem>> GetByIdsAsync(IEnumerable<int> ids)
        {
            if (ids == null || !ids.Any())
            {
        ...
        public Task<BasketItem> GetByNameAsync(string name)
        {
            throw new NotImplementedException();
        }

        public async Task<ResponseResult> UpdateAsync(BasketItem entity)
        {
